...
from phy_transceiver_rx_spi_28g import phy_transceiver_rx_spi_28g  # grc-generated hier_block
import gnuradio
import ieee802_11
import sip
...
class Transceiver_Station_RX_SPI_28G(gr.top_block, Qt.QWidget):

    def __init__(self, samp_rate=2000000):
        gr.top_block.__init__(self, "Transceiver Station RX SPI 28G", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transceiver Station RX SPI 28G")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transceiver_Station_RX_SPI_28G")
        ...
        self.phy_transceiver_rx_spi_28g_0 = phy_transceiver_rx_spi_28g(
        ...
        self.iNETS_PacketizedLink_stop_wait_arq_0 = iNETS_PacketizedLink.stop_wait_arq(True, 90e-3, 2, max_mtu_size, 0, scrambler_seed, init_tx_beam, init_rx_beam, 17, True, sta_code, partner_sta_code, '/home/inets/Workspace/GNURadio_logs/RX_SPI_28G/Stop_Wait_ARQ/')
        self.iNETS_PacketizedLink_RX_PHY_logger_0 = iNETS_PacketizedLink.RX_PHY_logger(sta_code, 'defined', '/home/inets/Workspace/GNURadio_logs/RX_SPI_28G/RX_PHY_Logger_events/', False, '/home/inets/Workspace/GNURadio_logs/RX_SPI_28G/RX_PHY_Logger_perposition/', False)
        self.iNETS_BeamManager_beamsteering_protocol_0 = iNETS_BeamManager.beamsteering_protocol(2, "_iNETS", 1, sta_code, False, 15, True, 0.2, 0.2, 0.1, 0.24, 0.065, 0.03, 0.03, 1.5, 0.035, 0.2, 0.8, 1.2, '', '/home/inets/Workspace/GNURadio_logs/RX_SPI_28G/Beamsteering_Protocol_events_configs/', False, '/home/inets/Workspace/GNURadio_logs/RX_SPI_28G/Beamsteering_Protocol_persector/', 11, 21, 2.0, 1.0, 3.0, 1, init_rx_beam, 0.03, True)
        ...
        self.msg_connect((self.phy_transceiver_rx_spi_28g_0, 'RX PHY out'), (self.iNETS_PacketizedLink_stop_wait_arq_0, 'phy_in'))
        self.msg_connect((self.phy_transceiver_rx_spi_28g_0, 'SNR out'), (self.iNETS_PacketizedLink_stop_wait_arq_0, 'snr_in'))
        self.connect((self.phy_transceiver_rx_spi_28g_0, 1), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.phy_transceiver_rx_spi_28g_0, 2), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.phy_transceiver_rx_spi_28g_0, 0), (self.qtgui_time_sink_x_2, 0))
    ...
    def set_samp_rate(self, samp_rate):
        self.samp_rate = samp_rate
        self.phy_transceiver_rx_spi_28g_0.set_samp_rate(self.samp_rate)
    ...
    def set_usrp_rx_subdev_spec(self, usrp_rx_subdev_spec):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_subdev_spec_RX(self.usrp_rx_subdev_spec)
    ...
    def set_usrp_rx_address(self, usrp_rx_address):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_usrp_rx_address(self.usrp_rx_address)
    ...
    def set_time_per_angle_sec(self, time_per_angle_sec):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_time_per_angle(self.time_per_angle_sec)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.phy_transceiver_rx_spi_28g_0.set_sps(self.sps)
    ...
    def set_rand_pad(self, rand_pad):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_rand_pad(self.rand_pad)
    ...
    def set_max_mtu_size(self, max_mtu_size):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_max_mtu_size(self.max_mtu_size)
    ...
    def set_detector_threshold(self, detector_threshold):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_detector_threshold(self.detector_threshold)
    ...
    def set_bb_freq(self, bb_freq):
        ...
        self.phy_transceiver_rx_spi_28g_0.set_bb_freq(self.bb_freq)
...
def main(top_block_cls=Transceiver_Station_RX_SPI_28G, options=None):
    if options is None:
