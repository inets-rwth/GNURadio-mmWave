...
# Title: Transceiver Station TX SPI Single Band 28G
...
from phy_transceiver_tx_spi_singleband_28g import phy_transceiver_tx_spi_singleband_28g  # grc-generated hier_block
import Transceiver_Station_TX_SPI_singleband_28G_epy_block_0 as epy_block_0  # embedded python block
import gnuradio
import ieee802_11
import sip
...
class Transceiver_Station_TX_SPI_singleband_28G(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transceiver Station TX SPI Single Band 28G", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transceiver Station TX SPI Single Band 28G")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transceiver_Station_TX_SPI_singleband_28G")
        ...
        for c in range(3, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.phy_transceiver_tx_spi_singleband_28g_0 = phy_transceiver_tx_spi_singleband_28g(
        ...
        self.msg_connect((self.iNETS_PacketizedLink_stop_wait_arq_0, 'phy_out'), (self.phy_transceiver_tx_spi_singleband_28g_0, 'TX PHY in'))
        ...
        self.connect((self.phy_transceiver_tx_spi_singleband_28g_0, 1), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.phy_transceiver_tx_spi_singleband_28g_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_usrp_tx_subdev_spec(self, usrp_tx_subdev_spec):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_subdev_spec_TX(self.usrp_tx_subdev_spec)
    ...
    def set_usrp_tx_address(self, usrp_tx_address):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_usrp_tx_address(self.usrp_tx_address)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.phy_transceiver_tx_spi_singleband_28g_0.set_sps(self.sps)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_samp_rate(self.samp_rate)
    ...
    def set_rand_pad(self, rand_pad):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_rand_pad(self.rand_pad)
    ...
    def set_max_mtu_size(self, max_mtu_size):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_max_mtu_size(self.max_mtu_size)
    ...
    def set_init_tx_beam(self, init_tx_beam):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_init_beam(self.init_tx_beam)
    ...
    def set_detector_threshold(self, detector_threshold):
        ...
        self.phy_transceiver_tx_spi_singleband_28g_0.set_detector_threshold(self.detector_threshold)
...
def main(top_block_cls=Transceiver_Station_TX_SPI_singleband_28G, options=None):
