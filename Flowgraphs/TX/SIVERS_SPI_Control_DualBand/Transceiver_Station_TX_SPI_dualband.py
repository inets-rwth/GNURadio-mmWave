...
class Transceiver_Station_TX_SPI_dualband(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.evk06002_trx_freq = evk06002_trx_freq = 58.32e9
        self.evk06002_serial = evk06002_serial = "T582304971"
        self.evk06002_init_tx_rf_gain = evk06002_init_tx_rf_gain = 0xFF
        self.evk02001_trx_freq = evk02001_trx_freq = 27.45e9
        self.evk02001_serial = evk02001_serial = "SNSP210157"
        self.evk02001_init_tx_rf_gain = evk02001_init_tx_rf_gain = 0x44
    ...
    def get_evk06002_trx_freq(self):
        return self.evk06002_trx_freq

    def set_evk06002_trx_freq(self, evk06002_trx_freq):
        self.evk06002_trx_freq = evk06002_trx_freq

    def get_evk06002_serial(self):
        return self.evk06002_serial

    def set_evk06002_serial(self, evk06002_serial):
        self.evk06002_serial = evk06002_serial

    def get_evk06002_init_tx_rf_gain(self):
        return self.evk06002_init_tx_rf_gain

    def set_evk06002_init_tx_rf_gain(self, evk06002_init_tx_rf_gain):
        self.evk06002_init_tx_rf_gain = evk06002_init_tx_rf_gain

    def get_evk02001_trx_freq(self):
        return self.evk02001_trx_freq

    def set_evk02001_trx_freq(self, evk02001_trx_freq):
        self.evk02001_trx_freq = evk02001_trx_freq

    def get_evk02001_serial(self):
        return self.evk02001_serial

    def set_evk02001_serial(self, evk02001_serial):
        self.evk02001_serial = evk02001_serial

    def get_evk02001_init_tx_rf_gain(self):
        return self.evk02001_init_tx_rf_gain

    def set_evk02001_init_tx_rf_gain(self, evk02001_init_tx_rf_gain):
        self.evk02001_init_tx_rf_gain = evk02001_init_tx_rf_gain
