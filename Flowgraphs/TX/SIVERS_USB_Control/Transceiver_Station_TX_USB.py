...
# Title: Transceiver Station TX USB
...
from phy_transceiver_tx_usb import phy_transceiver_tx_usb  # grc-generated hier_block
import Transceiver_Station_TX_USB_epy_block_0 as epy_block_0  # embedded python block
import gnuradio
import ieee802_11
import sip
...
class Transceiver_Station_TX_USB(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transceiver Station TX USB", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transceiver Station TX USB")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Transceiver_Station_TX_USB")
        ...
        self.usrp_tx_address = usrp_tx_address = "addr=192.168.100.46"
        self.sweeping = sweeping = True
        self.sta_code = sta_code = 1
        self.sps = sps = 4
        self.scrambler_seed = scrambler_seed = 111
        self.samp_rate = samp_rate = 2000000
        self.rand_pad = rand_pad = 20
        self.partner_sta_code = partner_sta_code = 2
        ...
        self.evk_serial = evk_serial = "SNSP210073"
        ...
        for c in range(3, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.phy_transceiver_tx_usb_0 = phy_transceiver_tx_usb(
        ...
        self.iNETS_SIVERSControl_evk02001_init_tx_0 = iNETS_SIVERSControl.evk02001_init_tx(evk_trx_freq, init_tx_beam, init_rx_beam, init_tx_rf_gain, 153, 238, 115, evk_serial, 0, 'MB1', '202111231800', 'None', False)
        ...
        self.iNETS_BeamManager_beamsteering_protocol_0 = iNETS_BeamManager.beamsteering_protocol(2, "_iNETS", 0, sta_code, False, 15, True, 0.2, 0.2, 0.1, 0.28, 0.065, 0.035, 0.065, 1.5, 0.035, 0.2, 0.8, 1.2, '', '/home/inets/Workspace/GNURadio_logs/TX_USB/Beamsteering_Protocol_events_configs/', False, '/home/inets/Workspace/GNURadio_logs/TX_USB/Beamsteering_Protocol_persector/', 11, 1, 2.0, 1.0, 3.0, 1, init_tx_beam, 0.035, True)
        ...
        self.msg_connect((self.iNETS_PacketizedLink_stop_wait_arq_0, 'phy_out'), (self.phy_transceiver_tx_usb_0, 'TX PHY in'))
        ...
        self.connect((self.phy_transceiver_tx_usb_0, 1), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.phy_transceiver_tx_usb_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_usrp_tx_subdev_spec(self, usrp_tx_subdev_spec):
        ...
        self.phy_transceiver_tx_usb_0.set_subdev_spec_TX(self.usrp_tx_subdev_spec)
    ...
    def set_usrp_tx_address(self, usrp_tx_address):
        ...
        self.phy_transceiver_tx_usb_0.set_usrp_tx_address(self.usrp_tx_address)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.phy_transceiver_tx_usb_0.set_sps(self.sps)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.phy_transceiver_tx_usb_0.set_samp_rate(self.samp_rate)
    ...
    def set_rand_pad(self, rand_pad):
        ...
        self.phy_transceiver_tx_usb_0.set_rand_pad(self.rand_pad)
    ...
    def set_max_mtu_size(self, max_mtu_size):
        ...
        self.phy_transceiver_tx_usb_0.set_max_mtu_size(self.max_mtu_size)
    ...
    def set_init_tx_beam(self, init_tx_beam):
        ...
        self.phy_transceiver_tx_usb_0.set_init_beam(self.init_tx_beam)
    ...
    def set_detector_threshold(self, detector_threshold):
        ...
        self.phy_transceiver_tx_usb_0.set_detector_threshold(self.detector_threshold)
    ...
    def set_bb_freq_28(self, bb_freq_28):
        ...
        self.phy_transceiver_tx_usb_0.set_bb_freq_28(self.bb_freq_28)




def main(top_block_cls=Transceiver_Station_TX_USB, options=None):
